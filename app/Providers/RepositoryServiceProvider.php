...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(\App\Repositories\Contracts\KitchenItemSetupRepository::class, \App\Repositories\Eloquent\KitchenItemSetupRepositoryEloquent::class);
        $this->app->bind(\App\Repositories\Contracts\KitchenPrinterRepository::class, \App\Repositories\Eloquent\KitchenPrinterRepositoryEloquent::class);
