...
class CancelConvertDataToFilePerEvent extends Command
{
     ...
     * @var string
     */
    protected $description = 'Cancel conversion process for Generate CSV (Changes Only).';
    ...
    public function handle()
    {
        ...
        $this->createLog(__('info.generate_csv_changes_only_cancelled').' @ '.$this->secondsToHumanReadableTime($executionTime), 'info', true);
